...
Chat with your own PDFs using a lightweight, **free-to-host** RAG pipeline .  
No Ollama or GPUs required — it run a **tiny Transformers chat model on CPU**, FAISS for retrieval, and maintain **conversational memory** between turns.
